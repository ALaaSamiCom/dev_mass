...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('works/media', 'WorksController@storeMedia')->name('works.storeMedia');
    Route::post('works/ckmedia', 'WorksController@storeCKEditorImages')->name('works.storeCKEditorImages');
    ...
    // Special Section
    Route::delete('special-sections/destroy', 'SpecialSectionController@massDestroy')->name('special-sections.massDestroy');
    Route::post('special-sections/media', 'SpecialSectionController@storeMedia')->name('special-sections.storeMedia');
    Route::post('special-sections/ckmedia', 'SpecialSectionController@storeCKEditorImages')->name('special-sections.storeCKEditorImages');
    Route::resource('special-sections', 'SpecialSectionController');

    // Layaoutplace
    Route::delete('layaoutplaces/destroy', 'LayaoutplaceController@massDestroy')->name('layaoutplaces.massDestroy');
    Route::resource('layaoutplaces', 'LayaoutplaceController');
    ...
    Route::post('our-missions/ckmedia', 'OurMissionController@storeCKEditorImages')->name('our-missions.storeCKEditorImages');
    Route::resource('our-missions', 'OurMissionController');

    // Choose
    Route::delete('chooses/destroy', 'ChooseController@massDestroy')->name('chooses.massDestroy');
    ...
    Route::resource('step-by-steps', 'StepByStepController');
