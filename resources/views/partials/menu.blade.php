            ...
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/sliders*") ? "c-show" : "" }} {{ request()->is("admin/services*") ? "c-show" : "" }} {{ request()->is("admin/works*") ? "c-show" : "" }} {{ request()->is("admin/categories*") ? "c-show" : "" }} {{ request()->is("admin/special-sections*") ? "c-show" : "" }} {{ request()->is("admin/layaoutplaces*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }} {{ request()->is("admin/our-missions*") ? "c-show" : "" }} {{ request()->is("admin/chooses*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('special_section_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.special-sections.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/special-sections") || request()->is("admin/special-sections/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('layaoutplace_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.layaoutplaces.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/layaoutplaces") || request()->is("admin/layaoutplaces/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('our_mission_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.our-missions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/our-missions") || request()->is("admin/our-missions/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('choose_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.chooses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/chooses") || request()->is("admin/chooses/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
            ...
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/pages*") ? "c-show" : "" }} {{ request()->is("admin/items*") ? "c-show" : "" }} {{ request()->is("admin/step-by-steps*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('step_by_step_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.step-by-steps.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/step-by-steps") || request()->is("admin/step-by-steps/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
            ...
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/settings*") ? "c-show" : "" }} {{ request()->is("admin/social-links*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('social_link_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.social-links.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/social-links") || request()->is("admin/social-links/*") ? "c-active" : "" }}">
