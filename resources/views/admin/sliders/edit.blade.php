    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.slider.fields.short_description_en_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="short_description_ar">{{ trans('cruds.slider.fields.short_description_ar') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('short_description_ar') ? 'is-invalid' : '' }}" name="short_description_ar" id="short_description_ar">{!! old('short_description_ar', $slider->short_description_ar) !!}</textarea>
                @if($errors->has('short_description_ar'))
                    <div class="invalid-feedback">
                        {{ $errors->first('short_description_ar') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.slider.fields.short_description_ar_helper') }}</span>
            </div>
            <div class="form-group">
