    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords_en') ? 'is-invalid' : '' }}" name="keywords_en" id="keywords_en">{{ old('keywords_en') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords_ar') ? 'is-invalid' : '' }}" name="keywords_ar" id="keywords_ar">{{ old('keywords_ar') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitudes') ? 'is-invalid' : '' }}" type="text" name="latitudes" id="latitudes" value="{{ old('latitudes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meridians') ? 'is-invalid' : '' }}" type="text" name="meridians" id="meridians" value="{{ old('meridians', '') }}">
