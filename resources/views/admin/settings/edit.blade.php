            ...
            <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text"
                           name="title_en" id="title_en" value="{{ old('title_en', $setting->title_en) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text"
                           name="title_ar" id="title_ar" value="{{ old('title_ar', $setting->title_ar) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('description_en') ? 'is-invalid' : '' }}"
                              name="description_en"
                              id="description_en">{!! old('description_en', $setting->description_en) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control  {{ $errors->has('description_ar') ? 'is-invalid' : '' }}"
                              name="description_ar"
                              id="description_ar">{!! old('description_ar', $setting->description_ar) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('keywords_en') ? 'is-invalid' : '' }}"
                              name="keywords_en"
                              id="keywords_en">{{ old('keywords_en', $setting->keywords_en) }}</textarea>
                ...
                <div class="form-group">
                    <label for="keywords_ar">{{ trans('cruds.setting.fields.keywords_ar') }}</label>
                    <textarea class="form-control {{ $errors->has('keywords_ar') ? 'is-invalid' : '' }}"
                              name="keywords_ar"
                              id="keywords_ar">{{ old('keywords_ar', $setting->keywords_ar) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('keywords_en') ? 'is-invalid' : '' }}"
                              name="head_tags" id="head_tags">{{ old('head_tags', $setting->head_tags) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('keywords_en') ? 'is-invalid' : '' }}"
                              name="body_tags" id="body_tags">{{ old('body_tags', $setting->body_tags) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text"
                           name="website" id="website" value="{{ old('website', $setting->website) }}">
                ...
                <div class="form-group">
                    <label for="latitudes">{{ trans('cruds.setting.fields.latitudes') }}</label>
                    <input class="form-control {{ $errors->has('latitudes') ? 'is-invalid' : '' }}" type="text"
                           name="latitudes" id="latitudes" value="{{ old('latitudes', $setting->latitudes) }}">
                    @if($errors->has('latitudes'))
                        <div class="invalid-feedback">
                            {{ $errors->first('latitudes') }}
                        </div>
                    @endif
                    <span class="help-block">{{ trans('cruds.setting.fields.latitudes_helper') }}</span>
                </div>
                <div class="form-group">
                    <label for="meridians">{{ trans('cruds.setting.fields.meridians') }}</label>
                    <input class="form-control {{ $errors->has('meridians') ? 'is-invalid' : '' }}" type="text"
                           name="meridians" id="meridians" value="{{ old('meridians', $setting->meridians) }}">
                    @if($errors->has('meridians'))
                        <div class="invalid-feedback">
                            {{ $errors->first('meridians') }}
                        </div>
                    @endif
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('place_en') ? 'is-invalid' : '' }}" type="text"
                           name="place_en" id="place_en" value="{{ old('place_en', $setting->place_en) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('place_ar') ? 'is-invalid' : '' }}" type="text"
                           name="place_ar" id="place_ar" value="{{ old('place_ar', $setting->place_ar) }}">
