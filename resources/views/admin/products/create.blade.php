    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('shortdescription_en') ? 'is-invalid' : '' }}" name="shortdescription_en" id="shortdescription_en">{!! old('shortdescription_en') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('shortdescription_ar') ? 'is-invalid' : '' }}" name="shortdescription_ar" id="shortdescription_ar">{!! old('shortdescription_ar') !!}</textarea>
