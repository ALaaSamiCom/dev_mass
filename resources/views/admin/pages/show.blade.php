        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.page.fields.short_description_en') }}
                        </th>
                        <td>
                            {!! $page->short_description_en !!}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.page.fields.short_description_ar') }}
                        </th>
                        <td>
                            {!! $page->short_description_ar !!}
                        </td>
                    </tr>
                    <tr>
                        <th>
...
<div class="card">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="step_item_items">
            @includeIf('admin.pages.relationships.stepItemItems', ['items' => $page->stepItemItems])
        </div>
    </div>
</div>
