    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('short_description_ar') ? 'is-invalid' : '' }}" name="short_description_ar" id="short_description_ar">{!! old('short_description_ar') !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Page::LAYOUT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('layout') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="layout_{{ $key }}" name="layout" value="{{ $key }}" {{ old('layout', '') === (string) $key ? 'checked' : '' }}>
