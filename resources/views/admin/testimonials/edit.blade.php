    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $testimonial->name_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $testimonial->name_en) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text_ar') ? 'is-invalid' : '' }}" name="text_ar" id="text_ar" required>{{ old('text_ar', $testimonial->text_ar) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_title_ar') ? 'is-invalid' : '' }}" type="text" name="job_title_ar" id="job_title_ar" value="{{ old('job_title_ar', $testimonial->job_title_ar) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_title_en') ? 'is-invalid' : '' }}" type="text" name="job_title_en" id="job_title_en" value="{{ old('job_title_en', $testimonial->job_title_en) }}">
