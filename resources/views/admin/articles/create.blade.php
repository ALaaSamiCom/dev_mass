            ...
            <form method="POST" action="{{ route("admin.articles.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text"
                           name="title_ar" id="title_ar" value="{{ old('title_ar', '') }}" required>
                ...
                <div class="form-group">
                    <label class="required"
                           for="description_en">{{ trans('cruds.article.fields.description_en') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.article.fields.description_en') }}</span>
                </div>
                <div class="form-group">
                    <label class="required"
                           for="description_ar">{{ trans('cruds.article.fields.description_ar') }}</label>
                ...
                <div class="form-group">
                    <label class="required"
                           for="author_name_en">{{ trans('cruds.article.fields.author_name_en') }}</label>
                    <input type="text"
                           class="form-control  {{ $errors->has('author_name_en') ? 'is-invalid' : '' }}"
                           name="author_name_en" id="author_name_en" value=" {!! old('description_en') !!}">
                ...
                <div class="form-group">
                    <label class="required"
                           for="author_name_ar">{{ trans('cruds.article.fields.author_name_ar') }}</label>
                    <input type="text"
                           class="form-control  {{ $errors->has('author_name_ar') ? 'is-invalid' : '' }}"
                           name="author_name_ar" id="author_name_ar" value="{!! old('author_name_ar') !!}">
                ...
                <div class="form-group">
                    <label class="required"
                           for="author_job_en">{{ trans('cruds.article.fields.author_job_en') }}</label>
                    <input type="text"
                           class="form-control  {{ $errors->has('author_job_en') ? 'is-invalid' : '' }}"
                           name="author_job_en" id="author_job_en" value=" {!! old('author_job_en') !!}">
                ...
                <div class="form-group">
                    <label class="required"
                           for="author_job_ar">{{ trans('cruds.article.fields.author_job_ar') }}</label>
                    <input type="text"
                           class="form-control  {{ $errors->has('author_job_ar') ? 'is-invalid' : '' }}"
                           name="author_job_ar" id="author_job_ar" value=" {!! old('author_job_ar') !!}">
                ...
                <div class="form-group">
                    <label for="author_image">{{ trans('cruds.article.fields.author_image') }}</label>
